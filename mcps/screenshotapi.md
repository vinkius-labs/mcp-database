...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/screenshotapi)
...
**Q: Can my AI automatically generate a PDF from a website URL?**
...
**Q: How do I take a screenshot specifically for mobile viewports?**
...
**Q: How do I find my ScreenshotAPI.net Token?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/screenshotapi](https://vinkius.com/en/ai-agent-connect/screenshotapi)
...
5. Click the **+** button in any chat and enable **ScreenshotAPI** under Connectors.
