# PII Redaction Deterministic Scrubber MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/pii-redaction-deterministic-scrubber)
...
Here are some examples of how you can interact with the **PII Redaction Deterministic Scrubber** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/pii-redaction-deterministic-scrubber](https://vinkius.com/en/ai-agent-connect/pii-redaction-deterministic-scrubber)
...
5. Click the **+** button in any chat and enable **PII Redaction Deterministic Scrubber** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `pii-redaction-deterministic-scrubber` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **PII Redaction Deterministic Scrubber** tools.
