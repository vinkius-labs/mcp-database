...
[![Available on Vinkius Edge](https://img.shields.io/badge/Run%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/health-gorilla)
[![Docker Pulls](https://img.shields.io/docker/pulls/vinkius/health-gorilla-mcp?style=for-the-badge&logo=docker&color=2496ed)](https://hub.docker.com/r/vinkius/health-gorilla-mcp)
...
To install and use the **Health Gorilla** MCP server in your AI agents (Claude, Cursor, Windsurf, etc.), follow these steps:
