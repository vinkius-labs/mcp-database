...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/checkoutcom-1)
...
**Q: Can my agent help me debug why a payment failed?**
...
**Q: Is it safe to manage card instruments via the AI agent?**
...
**Q: Can I test this in sandbox before going live?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/checkoutcom-1](https://vinkius.com/en/ai-agent-connect/checkoutcom-1)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `checkoutcom-1` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
