...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/gorgias)
...
## Available Tools (12)
- **create_customer**: Supply the required customer data in the JSON body.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/gorgias](https://vinkius.com/en/ai-agent-connect/gorgias)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `gorgias` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
