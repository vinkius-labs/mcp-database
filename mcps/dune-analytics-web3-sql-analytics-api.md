...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/dune-analytics-web3-sql-analytics-api)
...
**Q: How do I retrieve the actual data rows from a query?**
...
**Q: Can I stop a query that is taking too long to run?**
...
**Q: How do I pass parameters like dates or addresses to my Dune query?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/dune-analytics-web3-sql-analytics-api](https://vinkius.com/en/ai-agent-connect/dune-analytics-web3-sql-analytics-api)
...
5. Click the **+** button in any chat and enable **Dune Analytics (Web3 SQL Analytics API)** under Connectors.
