# ICU MessageFormat Validator MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/icu-messageformat-validator)
...
Here are some examples of how you can interact with the **ICU MessageFormat Validator** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/icu-messageformat-validator](https://vinkius.com/en/ai-agent-connect/icu-messageformat-validator)
...
5. Click the **+** button in any chat and enable **ICU MessageFormat Validator** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `icu-messageformat-validator` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **ICU MessageFormat Validator** tools.
