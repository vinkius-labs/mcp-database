...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/zerotier)
...
**Q: Can I authorize a new device to join my network using the AI?**
...
**Q: How do I check if my local ZeroTier service is running correctly?**
...
**Q: Can I see which peers my node is currently connected to?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/zerotier](https://vinkius.com/en/ai-agent-connect/zerotier)
...
5. Click the **+** button in any chat and enable **ZeroTier** under Connectors.
