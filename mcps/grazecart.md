...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/grazecart)
...
**Q: Can my agent update the inventory levels in GrazeCart?**
...
**Q: How do I process pending payments for orders via chat?**
...
**Q: Can I list active pickup locations for logistics planning through the agent?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/grazecart](https://vinkius.com/en/ai-agent-connect/grazecart)
...
5. Click the **+** button in any chat and enable **GrazeCart** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `grazecart` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **GrazeCart** tools.
