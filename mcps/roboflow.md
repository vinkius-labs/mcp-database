...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/roboflow)
...
- **create_folder**: Provide the workspace and desired folder name.

Create a project folder (Enterprise)
- **create_project**: Specify the workspace ID and project name.

Create a new project in a workspace
- **delete_images**: Specify the workspace, project, and array of image IDs.

Delete multiple images from a project
- **delete_project**: Provide the workspace, project, and version ID.

Delete a project or version (moves to Trash)
- **download_dataset**: Specify the workspace, project, version, and desired format.

Retrieve a download link for a zipped dataset in a specific format
- **fork_universe_project**: Supply the destination workspace and the source URL.
...
- **list_folders**: Provide the workspace ID or slug.
...
- **upload_annotation**: Supply the workspace, project, image ID, and annotation path.

Attach an annotation file to an existing image
- **upload_image**: Provide the workspace, project, and image data. Use batch_name for batch identification.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/roboflow](https://vinkius.com/en/ai-agent-connect/roboflow)
