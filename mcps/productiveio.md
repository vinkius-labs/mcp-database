...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/productiveio)
...
**Q: Can my AI automatically find the Organization ID for me?**
...
**Q: How do I find my Productive.io API Token?**
...
**Q: Does this work with time tracking?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/productiveio](https://vinkius.com/en/ai-agent-connect/productiveio)
...
5. Click the **+** button in any chat and enable **Productive.io** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `productiveio` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Productive.io** tools.
