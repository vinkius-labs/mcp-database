...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/pdf-munk)
...
- **generate_pdf_from_url**: Supports paper size, landscape orientation, and custom viewport settings.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/pdf-munk](https://vinkius.com/en/ai-agent-connect/pdf-munk)
