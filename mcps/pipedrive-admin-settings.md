# Pipedrive Admin & Settings MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/pipedrive-admin-settings)
...
Here are some examples of how you can interact with the **Pipedrive Admin & Settings** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/pipedrive-admin-settings](https://vinkius.com/en/ai-agent-connect/pipedrive-admin-settings)
...
5. Click the **+** button in any chat and enable **Pipedrive Admin & Settings** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `pipedrive-admin-settings` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Pipedrive Admin & Settings** tools.
