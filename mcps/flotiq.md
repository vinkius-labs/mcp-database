...
[![View on Vinkius](https://img.shields.io/badge/View_on-Vinkius-blue?style=for-the-badge)](https://vinkius.com/mcp/flotiq)
...
To install and use the **Flotiq** MCP server in your AI agents (Claude, Cursor, Windsurf, etc.), follow these steps:
