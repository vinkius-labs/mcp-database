...
[![Available on Vinkius Edge](https://img.shields.io/badge/Run%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/opportunity-cost-prover)
[![Docker Pulls](https://img.shields.io/docker/pulls/vinkius/opportunity-cost-prover-mcp?style=for-the-badge&logo=docker&color=2496ed)](https://hub.docker.com/r/vinkius/opportunity-cost-prover-mcp)
...
To install and use the **Opportunity Cost Prover** MCP server in your AI agents (Claude, Cursor, Windsurf, etc.), follow these steps:
