...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/payload-cms-extended)
...
- **get_global**: Get globalThis data
...
- **update_global**: Update globalThis data
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/payload-cms-extended](https://vinkius.com/en/ai-agent-connect/payload-cms-extended)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `payload-cms-extended` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
