...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/zoho-crm-activities)
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/zoho-crm-activities](https://vinkius.com/en/ai-agent-connect/zoho-crm-activities)
...
5. Click the **+** button in any chat and enable **Zoho CRM Activities** under Connectors.
