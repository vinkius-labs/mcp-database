...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/presenton)
...
2. Enter your Presenton API Key from your account settings
3. Start creating presentations using natural language prompts
...
Here are some examples of how you can interact with the **Presenton** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
**Q: Can I generate a full presentation using my AI agent?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/presenton](https://vinkius.com/en/ai-agent-connect/presenton)
...
5. Click the **+** button in any chat and enable **Presenton** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `presenton` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Presenton** tools.
