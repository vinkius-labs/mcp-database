# Slim Capital Prover MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/slim-capital-prover)
...
Here are some examples of how you can interact with the **Slim Capital Prover** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
**Q: Why does it reject 'revenue growth'?**
...
**Q: Why must markets have structural barriers?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/slim-capital-prover](https://vinkius.com/en/ai-agent-connect/slim-capital-prover)
...
5. Click the **+** button in any chat and enable **Slim Capital Prover** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `slim-capital-prover` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Slim Capital Prover** tools.
