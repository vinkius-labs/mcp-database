...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/bugherd)
...
- **create_project**: Supply both the Project name and the Development URL.
...
- **list_feedback**: Provide the Project ID.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/bugherd](https://vinkius.com/en/ai-agent-connect/bugherd)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `bugherd` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
