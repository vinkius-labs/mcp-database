...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/messenger)
...
**Q: Can the agent send messages to any Facebook user?**
...
**Q: Is it possible to retrieve full message history via the agent?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/messenger](https://vinkius.com/en/ai-agent-connect/messenger)
...
5. Click the **+** button in any chat and enable **Messenger** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `messenger` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Messenger** tools.
