...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/travis-ci)
...
**Q: Where do I retrieve my API Token for Travis CI?**
...
**Q: Can I permanently delete repositories via this interface?**
...
**Q: Can I use a single API Token for both travis-ci.com and travis-ci.org?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/travis-ci](https://vinkius.com/en/ai-agent-connect/travis-ci)
...
5. Click the **+** button in any chat and enable **Travis CI** under Connectors.
