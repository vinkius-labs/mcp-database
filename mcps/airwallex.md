...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/airwallex)
...
**Q: How do I find my Airwallex Client ID and API Key?**
...
**Q: Can I retrieve real-time FX quotes via AI?**
...
**Q: How do I check my multicurrency balances?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/airwallex](https://vinkius.com/en/ai-agent-connect/airwallex)
...
5. Click the **+** button in any chat and enable **Airwallex** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `airwallex` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Airwallex** tools.
