...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/concord-workflow-orchestration)
...
**Q: How do I create a Concord API token?**
...
**Q: What is an instance ID in Concord?**
...
**Q: Can I stop a running process?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/concord-workflow-orchestration](https://vinkius.com/en/ai-agent-connect/concord-workflow-orchestration)
...
5. Click the **+** button in any chat and enable **Concord (Workflow Orchestration)** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `concord-workflow-orchestration` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Concord (Workflow Orchestration)** tools.
