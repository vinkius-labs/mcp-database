...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/reamaze)
...
3. Set Type to "SSE", enter `reamaze` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
