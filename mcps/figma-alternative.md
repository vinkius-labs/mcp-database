...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/figma-alternative)
...
**Q: How do I create a Figma Personal Access Token?**
...
**Q: How do I find a Figma file key?**
...
**Q: Can I export images from Figma designs?**
...
**Q: Can I read and reply to comments on a design?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/figma-alternative](https://vinkius.com/en/ai-agent-connect/figma-alternative)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `figma-alternative` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
