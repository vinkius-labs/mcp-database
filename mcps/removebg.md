...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/removebg)
...
- **improve_result**: Provide at least one image input to execute the process.

Improve a previously processed result
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/removebg](https://vinkius.com/en/ai-agent-connect/removebg)
