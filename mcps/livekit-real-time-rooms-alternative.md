...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/ai-agent-connect/livekit-real-time-rooms-alternative)
...
- **send_ttvoice_data**: Use "reliable" for guaranteed delivery or "lossy" for low-latency.
...
1. View installation instructions and explore the server: [https://vinkius.com/ai-agent-connect/livekit-real-time-rooms-alternative](https://vinkius.com/ai-agent-connect/livekit-real-time-rooms-alternative)
...
{
  "mcpServers": {
    "livekit-real-time-rooms-alternative": {
