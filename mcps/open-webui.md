...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/open-webui)
...
**Q: How can I check if a model is available in my Open WebUI instance?**
...
**Q: Can I add a website to my RAG collection using just a URL?**
...
**Q: How do I know when my uploaded file is ready for querying?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/open-webui](https://vinkius.com/en/ai-agent-connect/open-webui)
...
5. Click the **+** button in any chat and enable **Open WebUI** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `open-webui` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Open WebUI** tools.
