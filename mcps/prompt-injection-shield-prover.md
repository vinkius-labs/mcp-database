...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/prompt-injection-shield-prover)
...
Here are some examples of how you can interact with the **Prompt Injection Shield Prover** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/prompt-injection-shield-prover](https://vinkius.com/en/ai-agent-connect/prompt-injection-shield-prover)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `prompt-injection-shield-prover` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
