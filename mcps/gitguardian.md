...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/gitguardian)
...
**Q: Can I resolve a secret incident directly through the AI?**
...
**Q: How do I create a decoy credential to catch attackers?**
...
**Q: Is it possible to scan a text block for secrets before I commit it?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/gitguardian](https://vinkius.com/en/ai-agent-connect/gitguardian)
...
5. Click the **+** button in any chat and enable **GitGuardian** under Connectors.
