...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/aerodatabox)
...
- **get_airline_fleet**: Supply the required ICAO code.

Get active aircraft operated by a given airline
- **get_airport_delays_historical**: Provide the ICAO code and date.

Get historical airport delays for a specific date
- **get_airport_delays_period**: Provide both start and end dates.

Get historical airport delays for a period
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/aerodatabox](https://vinkius.com/en/ai-agent-connect/aerodatabox)
