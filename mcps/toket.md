...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/toket)
...
**Q: Can I deploy a new NFT collection using the AI?**
...
**Q: How do I check my remaining balance for transaction fees (Gas)?**
...
**Q: Is it possible to track the status of an NFT minting process?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/toket](https://vinkius.com/en/ai-agent-connect/toket)
...
5. Click the **+** button in any chat and enable **Toket** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `toket` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Toket** tools.
