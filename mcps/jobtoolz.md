...
[![Available on Vinkius Edge](https://img.shields.io/badge/Run%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/jobtoolz)
[![Docker Pulls](https://img.shields.io/docker/pulls/vinkius/jobtoolz-mcp?style=for-the-badge&logo=docker&color=2496ed)](https://hub.docker.com/r/vinkius/jobtoolz-mcp)
...
To install and use the **Jobtoolz** MCP server in your AI agents (Claude, Cursor, Windsurf, etc.), follow these steps:
