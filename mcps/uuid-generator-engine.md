...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/uuid-generator-engine)
...
**Q: Which version should I use for database primary keys?**
...
**Q: When would I use v5 instead of v4?**
...
**Q: Can the AI generate valid UUIDs on its own?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/uuid-generator-engine](https://vinkius.com/en/ai-agent-connect/uuid-generator-engine)
...
5. Click the **+** button in any chat and enable **UUID Generator Engine** under Connectors.
