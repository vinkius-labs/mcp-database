...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/uk-ons-full-complete-statistical-intelligence)
...
**Q: What datasets does this server pull from?**
...
**Q: Are the GDP and Inflation figures real-time?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/uk-ons-full-complete-statistical-intelligence](https://vinkius.com/en/ai-agent-connect/uk-ons-full-complete-statistical-intelligence)
...
5. Click the **+** button in any chat and enable **UK ONS Full — Complete Statistical Intelligence** under Connectors.
