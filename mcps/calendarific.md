...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/calendarific)
...
- **list_holidays_by_location**: Requires country, year, and location.

List holidays for a specific state or region
- **list_holidays**: Provide both month and day to narrow the search.

List holidays for a specific country and year
- **list_holidays_by_type**: Requires country and year.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/calendarific](https://vinkius.com/en/ai-agent-connect/calendarific)
