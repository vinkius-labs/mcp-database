...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/blastscan-blast-network-explorer)
...
**Q: Can I check the balance of multiple Blast addresses at once?**
...
**Q: How can I track specific ERC20 token transfers for a wallet?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/blastscan-blast-network-explorer](https://vinkius.com/en/ai-agent-connect/blastscan-blast-network-explorer)
...
5. Click the **+** button in any chat and enable **Blastscan (Blast Network Explorer)** under Connectors.
