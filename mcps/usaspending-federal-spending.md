...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/usaspending-federal-spending)
...
**Q: How do I get an overview of a specific agency's spending?**
...
**Q: Can I see which sub-agencies are spending the most within a department?**
...
**Q: Is it possible to filter federal awards by geographic location?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/usaspending-federal-spending](https://vinkius.com/en/ai-agent-connect/usaspending-federal-spending)
...
5. Click the **+** button in any chat and enable **USAspending (Federal Spending)** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `usaspending-federal-spending` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **USAspending (Federal Spending)** tools.
