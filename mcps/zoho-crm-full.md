...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/zoho-crm-full)
...
Here are some examples of how you can interact with the **Zoho CRM (Full)** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/zoho-crm-full](https://vinkius.com/en/ai-agent-connect/zoho-crm-full)
...
5. Click the **+** button in any chat and enable **Zoho CRM (Full)** under Connectors.
