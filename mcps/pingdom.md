...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/pingdom)
...
**Q: How do I create a Pingdom API Token?**
...
**Q: Can I see response times for different global regions?**
...
**Q: Does this support pausing multiple checks at once?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/pingdom](https://vinkius.com/en/ai-agent-connect/pingdom)
...
5. Click the **+** button in any chat and enable **Pingdom** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `pingdom` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Pingdom** tools.
