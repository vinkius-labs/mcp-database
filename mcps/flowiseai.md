...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/flowiseai)
...
- **list_flow_variables**: List globalThis variables
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/flowiseai](https://vinkius.com/en/ai-agent-connect/flowiseai)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `flowiseai` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
