# Qdrant Payload Filter Builder Alternative MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/qdrant-payload-filter-builder-alternative)
...
Here are some examples of how you can interact with the **Qdrant Payload Filter Builder Alternative** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/mcp/qdrant-payload-filter-builder-alternative](https://vinkius.com/mcp/qdrant-payload-filter-builder-alternative)
...
5. Click the **+** button in any chat and enable **Qdrant Payload Filter Builder Alternative** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `qdrant-payload-filter-builder-alternative` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Qdrant Payload Filter Builder Alternative** tools.
