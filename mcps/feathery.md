...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/feathery)
...
- **get_workflow_details**: Provide the Workflow ID to fetch the required information.

Get details for a specific workflow
- **list_connector_logs**: You must provide the Form ID.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/feathery](https://vinkius.com/en/ai-agent-connect/feathery)
