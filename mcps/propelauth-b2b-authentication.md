...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/propelauth-b2b-authentication)
...
**Q: Can I find a user's details using only their email address?**
...
**Q: How do I add an existing user to a specific organization?**
...
**Q: Is it possible to monitor how many times an API key has been used?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/propelauth-b2b-authentication](https://vinkius.com/en/ai-agent-connect/propelauth-b2b-authentication)
...
5. Click the **+** button in any chat and enable **PropelAuth (B2B Authentication)** under Connectors.
