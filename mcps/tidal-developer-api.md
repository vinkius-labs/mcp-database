...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/tidal-developer-api)
...
**Q: How do I find my TIDAL API Key?**
...
**Q: Can the agent show track durations?**
...
**Q: Does it support high-resolution audio info?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/tidal-developer-api](https://vinkius.com/en/ai-agent-connect/tidal-developer-api)
...
5. Click the **+** button in any chat and enable **TIDAL Developer API** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `tidal-developer-api` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **TIDAL Developer API** tools.
