...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/sec-edgar-filings-10-k-10-q-8-k-insider-trades-full-text-search)
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/sec-edgar-filings-10-k-10-q-8-k-insider-trades-full-text-search](https://vinkius.com/en/ai-agent-connect/sec-edgar-filings-10-k-10-q-8-k-insider-trades-full-text-search)
