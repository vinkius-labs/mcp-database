...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/qualifiedio)
...
**Q: Can I see a summary of a candidate's test performance without pulling the full raw data?**
...
**Q: How do I invite multiple candidates to a specific assessment at once?**
...
**Q: Is it possible to reopen a test for a candidate who had technical issues?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/qualifiedio](https://vinkius.com/en/ai-agent-connect/qualifiedio)
...
5. Click the **+** button in any chat and enable **Qualified.io** under Connectors.
