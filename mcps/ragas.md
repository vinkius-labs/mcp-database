...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/ragas)
...
**Q: How do I secure an App Token for Ragas?**
...
**Q: What format is required to upload a dataset?**
...
**Q: Does the server evaluate prompts automatically during testing?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/ragas](https://vinkius.com/en/ai-agent-connect/ragas)
...
5. Click the **+** button in any chat and enable **Ragas** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `ragas` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Ragas** tools.
