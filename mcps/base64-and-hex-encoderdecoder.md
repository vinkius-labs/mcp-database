# Base64 and Hex Encoder/Decoder MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/base64-and-hex-encoderdecoder)
...
Here are some examples of how you can interact with the **Base64 and Hex Encoder/Decoder** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/base64-and-hex-encoderdecoder](https://vinkius.com/en/ai-agent-connect/base64-and-hex-encoderdecoder)
...
5. Click the **+** button in any chat and enable **Base64 and Hex Encoder/Decoder** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `base64-and-hex-encoderdecoder` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Base64 and Hex Encoder/Decoder** tools.
