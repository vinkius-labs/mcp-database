...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/dbeaver-cloudbeaver)
...
**Q: How can I see which database types are supported by my CloudBeaver server?**
...
**Q: Can I check if a specific database connection is active and properly configured?**
...
**Q: What file formats are available for exporting data from my databases?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/dbeaver-cloudbeaver](https://vinkius.com/en/ai-agent-connect/dbeaver-cloudbeaver)
...
5. Click the **+** button in any chat and enable **DBeaver (CloudBeaver)** under Connectors.
