...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/nyckel-ml)
...
**Q: How do I get my Nyckel credentials?**
...
**Q: Does this support image classification?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/nyckel-ml](https://vinkius.com/en/ai-agent-connect/nyckel-ml)
...
5. Click the **+** button in any chat and enable **Nyckel ML** under Connectors.
