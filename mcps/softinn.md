...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/softinn)
...
**Q: How do I obtain a Softinn API Key?**
...
**Q: Can my AI automatically update room statuses for cleaning?**
...
**Q: Does it support real-time availability searching?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/softinn](https://vinkius.com/en/ai-agent-connect/softinn)
...
5. Click the **+** button in any chat and enable **Softinn** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `softinn` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Softinn** tools.
