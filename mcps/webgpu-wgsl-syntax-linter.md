# WebGPU WGSL Syntax Linter MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/webgpu-wgsl-syntax-linter)
...
Here are some examples of how you can interact with the **WebGPU WGSL Syntax Linter** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/webgpu-wgsl-syntax-linter](https://vinkius.com/en/ai-agent-connect/webgpu-wgsl-syntax-linter)
...
5. Click the **+** button in any chat and enable **WebGPU WGSL Syntax Linter** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `webgpu-wgsl-syntax-linter` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **WebGPU WGSL Syntax Linter** tools.
