...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/feedly)
...
- **list_collections**: Do not specify any filters when calling this tool.

List all your Feedly collections (categories) and feeds
- **mark_as_read**: Pass a comma-separated list of entry IDs.
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/feedly](https://vinkius.com/en/ai-agent-connect/feedly)
