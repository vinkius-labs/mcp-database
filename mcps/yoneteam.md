...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/yoneteam)
...
**Q: Can I see the pricing details of a specific supplier offer?**
...
**Q: How do I check when a purchase order is scheduled to arrive?**
...
**Q: Is it possible to list all materials available in our catalog?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/yoneteam](https://vinkius.com/en/ai-agent-connect/yoneteam)
...
5. Click the **+** button in any chat and enable **YoneTeam** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `yoneteam` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **YoneTeam** tools.
