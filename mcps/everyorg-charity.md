...
[![View on Vinkius](https://img.shields.io/badge/View_on-Vinkius-blue?style=for-the-badge)](https://vinkius.com/mcp/everyorg-charity)
...
To install and use the **Every.org Charity** MCP server in your AI agents (Claude, Cursor, Windsurf, etc.), follow these steps:
