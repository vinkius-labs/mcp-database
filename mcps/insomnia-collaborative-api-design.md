...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/insomnia-collaborative-api-design)
...
**Q: Can I fetch full OpenAPI specifications through my agent?**
...
**Q: How do I see the environments defined in a team project?**
...
**Q: Can my agent check if a mock server is currently online?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/insomnia-collaborative-api-design](https://vinkius.com/en/ai-agent-connect/insomnia-collaborative-api-design)
...
5. Click the **+** button in any chat and enable **Insomnia (Collaborative API Design)** under Connectors.
