...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/scytale-security-compliance-automation)
...
**Q: Can I check my current compliance status across all frameworks?**
...
**Q: How do I upload new evidence for an audit requirement?**
...
**Q: Can I see a history of actions performed within the platform?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/scytale-security-compliance-automation](https://vinkius.com/en/ai-agent-connect/scytale-security-compliance-automation)
...
5. Click the **+** button in any chat and enable **Scytale (Security Compliance Automation)** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `scytale-security-compliance-automation` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Scytale (Security Compliance Automation)** tools.
