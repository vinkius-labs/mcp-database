...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/albi-restoration)
...
**Q: How do I find my Albi API Key?**
...
**Q: Can I track financial KPIs via AI?**
...
**Q: How do I check available inventory?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/albi-restoration](https://vinkius.com/en/ai-agent-connect/albi-restoration)
...
5. Click the **+** button in any chat and enable **Albi Restoration** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `albi-restoration` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Albi Restoration** tools.
