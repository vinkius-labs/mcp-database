...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/tollguru-alternative)
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/tollguru-alternative](https://vinkius.com/en/ai-agent-connect/tollguru-alternative)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `tollguru-alternative` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
