# CSV Structural Scan and Deduplicator MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/csv-structural-scan-and-deduplicator)
...
Here are some examples of how you can interact with the **CSV Structural Scan and Deduplicator** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/csv-structural-scan-and-deduplicator](https://vinkius.com/en/ai-agent-connect/csv-structural-scan-and-deduplicator)
...
5. Click the **+** button in any chat and enable **CSV Structural Scan and Deduplicator** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `csv-structural-scan-and-deduplicator` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **CSV Structural Scan and Deduplicator** tools.
