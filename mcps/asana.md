...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/asana)
...
- **add_task_comment**: Add a comment to an Asana task
- **delete_task**: Delete an Asana task permanently
- **get_user**: Get details of a specific Asana user
- **list_portfolios**: List portfolios in a workspace


## 💬 Prompt Examples

Here are some examples of how you can interact with the **Asana** MCP server using an AI Agent (Claude, ChatGPT, etc.).
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/asana](https://vinkius.com/en/ai-agent-connect/asana)
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `asana` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
