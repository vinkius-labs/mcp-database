...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/coderpad)
...
**Q: Can I see the code a candidate wrote in a pad through the agent?**
...
**Q: How do I check the full event log for an interview session?**
...
**Q: Where do I find my CoderPad API Key?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/coderpad](https://vinkius.com/en/ai-agent-connect/coderpad)
...
5. Click the **+** button in any chat and enable **CoderPad** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `coderpad` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **CoderPad** tools.
