...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/netlify)
...
**Q: Can I check if my latest deploy was successful using the agent?**
...
**Q: How do I trigger a new build for my site?**
...
**Q: Does the integration allow me to see contact form submissions?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/netlify](https://vinkius.com/en/ai-agent-connect/netlify)
