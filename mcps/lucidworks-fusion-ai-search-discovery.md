...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/lucidworks-fusion-ai-search-discovery)
...
2. Enter your Lucidworks Host URL and API Token
3. Start optimizing your enterprise search from Claude, Cursor, or any MCP-compatible client

### Who is this for?

- **Search Engineers** — test query profiles and verify indexing results through natural conversation without manual API tools
- **Data Scientists** — monitor ML job statuses and verify signal ingestion to ensure ranking models are correctly fine-tuned
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/lucidworks-fusion-ai-search-discovery](https://vinkius.com/en/ai-agent-connect/lucidworks-fusion-ai-search-discovery)
