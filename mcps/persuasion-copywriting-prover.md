# Persuasion Copywriting Prover MCP Server

[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/persuasion-copywriting-prover)
...
**Q: What types of copy does this validate?**
...
**Q: How does it detect AI-generated copy?**
...
**Q: Why framework matching matters?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/persuasion-copywriting-prover](https://vinkius.com/en/ai-agent-connect/persuasion-copywriting-prover)
...
5. Click the **+** button in any chat and enable **Persuasion Copywriting Prover** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `persuasion-copywriting-prover` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Persuasion Copywriting Prover** tools.
