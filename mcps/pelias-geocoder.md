...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/pelias-geocoder)
...
1. Authorize natively linking your own hosted/cloud structure parameters implicitly 
2. Configure explicit Pelias bounds entering base URLs structurally and logging your valid API Token dynamically
3. Execute spatial limits checking text and coordinates seamlessly querying instances via chat
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/pelias-geocoder](https://vinkius.com/en/ai-agent-connect/pelias-geocoder)
