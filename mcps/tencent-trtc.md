...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/tencent-trtc)
...
**Q: Does this support Tencent Cloud API v3 signature?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/tencent-trtc](https://vinkius.com/en/ai-agent-connect/tencent-trtc)
...
5. Click the **+** button in any chat and enable **Tencent TRTC** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `tencent-trtc` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Tencent TRTC** tools.
