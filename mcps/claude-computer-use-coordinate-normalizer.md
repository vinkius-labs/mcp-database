...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/ai-agent-connect/claude-computer-use-coordinate-normalizer)
...
1. View installation instructions and explore the server: [https://vinkius.com/ai-agent-connect/claude-computer-use-coordinate-normalizer](https://vinkius.com/ai-agent-connect/claude-computer-use-coordinate-normalizer)
