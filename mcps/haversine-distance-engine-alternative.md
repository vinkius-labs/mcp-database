...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/haversine-distance-engine-alternative)
...
**Q: Does it calculate driving distance?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/haversine-distance-engine-alternative](https://vinkius.com/en/ai-agent-connect/haversine-distance-engine-alternative)
...
5. Click the **+** button in any chat and enable **Haversine Distance Engine** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `haversine-distance-engine-alternative` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
...
{
  "mcpServers": {
    "haversine-distance-engine-alternative": {
