...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/mcp/firstquadrant-alternative)
...
**Q: Can I start a specific marketing campaign using its ID?**
...
**Q: Is it possible to manage and list my API keys through the agent?**
...
**Q: How do I check my current authentication status?**
