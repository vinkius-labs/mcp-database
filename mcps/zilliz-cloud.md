...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/zilliz-cloud)
...
**Q: How do I find my Cluster Endpoint?**
...
**Q: Why do I need to 'load' a collection before searching?**
...
**Q: Can I filter my vector search using metadata?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/zilliz-cloud](https://vinkius.com/en/ai-agent-connect/zilliz-cloud)
...
5. Click the **+** button in any chat and enable **Zilliz Cloud** under Connectors.
...
3. Set Type to "SSE" (or "streamable HTTP"), enter `zilliz-cloud` as the name, and paste the MCP server link (`https://edge.vinkius.com/[TOKEN]/mcp`).
4. Click **Save** — Cursor will connect and list all **Zilliz Cloud** tools.
