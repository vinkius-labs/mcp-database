...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/simpletexting)
...
**Q: Can my AI automatically send an SMS broadcast to a specific contact list?**
...
**Q: How do I schedule a text message for a future date using the AI?**
...
**Q: How do I find my SimpleTexting API v2 Token?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/simpletexting](https://vinkius.com/en/ai-agent-connect/simpletexting)
...
5. Click the **+** button in any chat and enable **SimpleTexting** under Connectors.
