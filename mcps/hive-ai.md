...
- **detect_ai_generated_image**: Provide the image URL.
...
- **list_available_models**: Specify the project type (visual or text).

List all Hive AI models available for your project
- **detect_ai_generated_text**: Provide the full text content as input.

Detect if a block of text was generated by an AI model (e.g., GPT-4)
- **get_async_task_result**: Supply both the task ID and project type.

Retrieve the final moderation results for a completed task
- **get_project_details**: Specify the project type (visual or text).
