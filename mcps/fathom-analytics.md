...
[![Deploy on Vinkius Edge](https://img.shields.io/badge/Deploy%20on-Vinkius%20Edge-blue?style=for-the-badge)](https://vinkius.com/en/ai-agent-connect/fathom-analytics)
...
**Q: How do I obtain a Fathom Analytics API Token?**
...
**Q: Does every API request count as a pageview?**
...
**Q: Can I see current live visitors through this agent?**
...
1. View installation instructions and explore the server: [https://vinkius.com/en/ai-agent-connect/fathom-analytics](https://vinkius.com/en/ai-agent-connect/fathom-analytics)
...
5. Click the **+** button in any chat and enable **Fathom Analytics** under Connectors.
