...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **7,908 unique Vinkius MCP servers**.
...
- [utility](categories/utility.md) (26 servers)
...
- [simulation](categories/simulation.md) (18 servers)
...
- [safety](categories/safety.md) (15 servers)
...
- [environment](categories/environment.md) (8 servers)
- [scheduling](categories/scheduling.md) (8 servers)
- [sports](categories/sports.md) (8 servers)
- [statistics](categories/statistics.md) (8 servers)
...
- [meteorology](categories/meteorology.md) (2 servers)
