...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **8,303 unique Vinkius MCP servers**.
...
- [engineering](categories/engineering.md) (280 servers)
...
- [analytics](categories/analytics.md) (82 servers)
...
- [sustainability](categories/sustainability.md) (11 servers)
...
- [energy](categories/energy.md) (6 servers)
...
- [risk-assessment](categories/risk-assessment.md) (4 servers)
