...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **7,688 unique Vinkius MCP servers**.
...
- [finance](categories/finance.md) (673 servers)
...
- [infrastructure](categories/infrastructure.md) (43 servers)
