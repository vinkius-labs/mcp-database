...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **6,127 unique Vinkius MCP servers**.
...
- [finance](categories/finance.md) (287 servers)
