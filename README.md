...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **7,798 unique Vinkius MCP servers**.
...
- [finance](categories/finance.md) (725 servers)
...
- [infrastructure](categories/infrastructure.md) (68 servers)
