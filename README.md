...
Welcome to the **Vinkius Open Data Initiative**. This repository provides open access to the Vinkius Model Context Protocol (MCP) catalog, featuring automatically updated documentation for **5,918 unique Vinkius MCP servers**.
...
- [productivity](categories/productivity.md) (906 servers)
- [developer-tools](categories/developer-tools.md) (609 servers)
- [industry-titans](categories/industry-titans.md) (584 servers)
...
- [finance](categories/finance.md) (237 servers)
...
- [artificial-intelligence](categories/artificial-intelligence.md) (55 servers)
...
- [optimization](categories/optimization.md) (5 servers)
...
- [data-extraction](categories/data-extraction.md) (2 servers)
...
- [validation](categories/validation.md) (1 servers)
