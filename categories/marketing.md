...
Explore the open database of **marketing** Model Context Protocol (MCP) servers.
...
| [Referral Program Copy Scorer](../mcps/referral-program-copy-scorer.md) | Analyze referral program marketing copy for clarity, friction, and effectiveness. |
...
| [Serasa Infomais — People & Organization Enrichment](../mcps/serasa-infomais-people-organization-enrichment.md) | Enrich CPFs and CNPJs with dozens of attributes, and reverse-lookup documents from partial data. |
...
| [Social Growth Projector](../mcps/social-growth-projector.md) | Project follower growth using compound monthly percentage and viral spike scenarios. |
| [Social Media Engagement Calculator](../mcps/social-media-engagement-calculator.md) | Calculate platform-specific engagement rates for Instagram and LinkedIn and compare them against industry benchmarks. |
| [Social Proof Strength Calculator](../mcps/social-proof-strength-calculator.md) | Quantify the reliability of testimonials and reviews using specificity and credibility analysis. |
