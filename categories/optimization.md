...
| [AI Portfolio Economics Optimizer](../mcps/ai-portfolio-economics-optimizer.md) | Calculate optimal LLM and SLM model mixes to minimize costs while meeting performance requirements. |
...
| [Refinery Energy Balance](../mcps/refinery-energy-balance.md) | Audit and optimize refinery energy consumption and efficiency. |
| [Smart Well Control Optimization](../mcps/smart-well-control-optimization.md) | Optimize ICV settings to maximize oil recovery and manage production constraints. |
