# sales-automation MCP Servers

Explore the open database of **sales-automation** Model Context Protocol (MCP) servers.
...
| [Boostapp](../mcps/boostapp.md) | Automate lead management in Boostapp — create new leads, assign pipeline stages, and manage customer data directly from any AI agent. |
...
| [CommPeak](../mcps/commpeak.md) | Enable your AI agent to manage dialer campaigns, leads, and send SMS messages via the CommPeak API. |
| [ConnectAndSell](../mcps/connectandsell.md) | Empower your conversational AI to interact with and review metrics from ConnectAndSell's B2B sales acceleration dialer. |
| [ContactOut](../mcps/contactout.md) | Find personal emails and direct phone numbers for professionals on LinkedIn to build targeted outreach lists that convert. |
| [CRM PipeRun](../mcps/crm-piperun.md) | Manage your sales pipeline and activities via PipeRun — track tasks, upload files, and organize deals directly from any AI agent. |
...
| [Paycove](../mcps/paycove.md) | Automate smart quotes, invoice generation, and CPQ workflows directly from your CRM using AI agents. |
| [PeopleDB](../mcps/peopledb.md) | Supercharge your lead generation by letting AI agents enrich B2B profiles and verify contact data instantly. |
...
| [Zendesk Sell](../mcps/zendesk-sell.md) | Manage sales leads, contacts, and deals via the Zendesk Sell (Base CRM) API. |
| [Zixflow](../mcps/zixflow.md) | Manage sales collections, contacts, and transactions via the Zixflow API. |
| [Zoho CRM Contacts](../mcps/zoho-crm-contacts.md) | Search, create, and manage contacts, leads, and accounts — with lead conversion and related records in Zoho CRM. |
| [Zoho CRM Sales](../mcps/zoho-crm-sales.md) | Deep deal management with quotes, products, sales orders, and invoices — complete sales cycle in Zoho CRM. |
