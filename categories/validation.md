...
|-----------|-------------|
| [Constraint Satisfaction Verifier](../mcps/constraint-satisfaction-verifier.md) | A deterministic validator for LLM outputs to enforce strict business and structural constraints. |
