...
| [Dry Needling Depth Calculator](../mcps/dry-needling-depth-calculator.md) | Calculates safe needle insertion parameters for trigger point therapy. |
...
| [Electrotherapy Dosage Calculator](../mcps/electrotherapy-dosage-calculator.md) | Clinical decision support for determining electrotherapy parameters. |
...
| [Muscle Energy Technique Guide](../mcps/muscle-energy-technique-guide.md) | Generates precise Muscle Energy Technique (MET) protocols for clinical use. |
| [Myotherapy Treatment Planner](../mcps/myotherapy-treatment-planner.md) | Generates clinical myotherapy treatment plans based on pain, trigger points, and movement restrictions. |
| [Neuromuscular Therapy Protocol Generator](../mcps/neuromuscular-therapy-protocol-generator.md) | Generates clinical NMT treatment sequences, pressure regimes, and stretching protocols. |
...
| [Sleep Restriction Therapy Planner](../mcps/sleep-restriction-therapy-planner.md) | Clinical tool for planning CBT-I sleep restriction protocols. |
| [SOFA Score Calculator](../mcps/sofa-score-calculator.md) | Calculate SOFA scores, mortality risk, and sepsis status. |
| [Strain-Counterstrain Protocol](../mcps/strain-counterstrain-protocol.md) | Generates standardized neuromuscular treatment protocols using Jones Counterstrain methodology. |
