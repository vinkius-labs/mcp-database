...
| [Family Storage Volume Manager](../mcps/family-storage-volume-manager.md) | Calculate and manage the total volume of physical storage containers for households. |
...
| [Kriging Estimation Model](../mcps/kriging-estimation-model.md) | Perform Ordinary Kriging to estimate block grades and spatial uncertainty. |
...
| [Mocktail Recipe Scaler](../mcps/mocktail-recipe-scaler.md) | Precision scaling for non-alcoholic cocktail recipes, accounting for ice displacement and flavor balance. |
...
| [Penalty Shootout Simulator](../mcps/penalty-shootout-simulator.md) | A deterministic engine to resolve football penalty shootouts and determine winners. |
...
| [Tournament Group Qualifier](../mcps/tournament-group-qualifier.md) | Calculate football tournament standings and qualification results. |
...
| [Win-Draw-Loss Probability Engine](../mcps/win-draw-loss-probability-engine.md) | Aggregates football scoreline matrices into match outcome probabilities and fair decimal odds. |
