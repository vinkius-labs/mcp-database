...
Explore the open database of **customer-support** Model Context Protocol (MCP) servers.
...
| [AskHandle](../mcps/askhandle-alternative.md) | Manage AI chat rooms, capture leads, and automate messaging workflows directly through AskHandle. |
| [AskHandle](../mcps/askhandle.md) | Integrate custom AI agents with AskHandle. |
| [Assembled](../mcps/assembled.md) | Manage support workforce and scheduling with Assembled — track agent states, teams, and forecasts via AI. |
...
| [BotGenuity](../mcps/botgenuity.md) | Create and manage AI chatbots with custom knowledge bases that answer customer questions accurately around the clock. |
| [BotPenguin](../mcps/botpenguin.md) | Manage your chatbots and live chat via BotPenguin — list contacts, orchestrate chats, and send messages directly from any AI agent. |
| [Botsonic](../mcps/botsonic.md) | Train custom AI chatbots on your own data to deliver instant, accurate support that learns from your knowledge base. |
| [CallPage](../mcps/callpage.md) | Manage callbacks and leads via CallPage — track calls, manage widgets, and coordinate with your sales team directly from any AI agent. |
| [ChargeDesk](../mcps/chargedesk.md) | Manage billing and payments via ChargeDesk — track charges, refund payments, and manage customers across multiple gateways directly from any AI agent. |
| [ChatFly](../mcps/chatfly-alternative.md) | Launch conversational AI chatbots that qualify leads, answer product questions, and book meetings without human intervention. |
| [CHATFLY](../mcps/chatfly.md) | Manage AI chatbots and knowledge bases via CHATFLY — train bots on custom data and track conversations directly from any AI agent. |
| [ChatGen](../mcps/chatgen.md) | Convert website visitors into qualified leads with AI chatbots that engage, qualify, and route prospects in real time. |
| [Chatsistant](../mcps/chatsistant.md) | Deploy white-label AI assistants for your clients with custom branding, knowledge bases, and conversation analytics. |
...
| [Delighted](../mcps/delighted.md) | Equip your AI agent to monitor customer feedback, track NPS metrics, and manage survey responses via the Delighted API. |
...
| [Surveypal](../mcps/surveypal.md) | Design employee experience surveys and customer feedback programs with analytics that turn responses into actionable improvements. |
| [TrueReview](../mcps/truereview.md) | Collect authentic customer reviews with automated requests and showcase testimonials that build trust and drive conversions. |
| [Udesk / 沃丰科技](../mcps/udesk.md) | Comprehensive customer service platform — manage tickets, customers, and knowledge base via AI. |
| [WorkWave](../mcps/workwave.md) | Manage service orders, customer accounts, and field technicians on WorkWave — the field service management platform. |
| [Zendesk QA (Klaus)](../mcps/zendesk-qa-klaus.md) | Export QA reviews, search conversations, and import ticket data via the Klaus (Zendesk QA) API. |
| [Zenloop](../mcps/zenloop.md) | Analyze NPS feedback and manage customer surveys via the Zenloop API. |
| [Zoho CRM Service](../mcps/zoho-crm-service.md) | Manage support cases and knowledge base solutions — customer service operations through Zoho CRM. |
