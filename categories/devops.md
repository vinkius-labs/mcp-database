...
| [Performance Regression Detector](../mcps/performance-regression-detector.md) | Detects performance regressions and degradation trends in LLM agent execution times. |
